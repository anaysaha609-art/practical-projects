...
generator relies on the following technical components:
...
To utilize generator, follow these steps:
...
generator accepts the following command line flags:
...
```bash
python generator.py -d /path/to/project -o /path/to/output -i
```

## Open-Source License

generator is licensed under the MIT license.
